...
//					"			</tr>");
            ...
            while (rs.next()) {
                 ...
                 */
                pw.println(this.addBookToCardCard(bCode, bName, bAuthor, bPrice, bQty, imageUrl));
            }
            pw.println("</div>\r\n"
                    + "    </div>");
//			pw.println("</table>\r\n" + 
//					"	</div>");
    ...
    public String addBookToCardCard(String bCode, String bName, String bAuthor, int bPrice, int bQty, String imageUrl) {
        ...
        return "<div class=\"card\">\r\n"
                ...
                + "                    <img class=\"col-sm-6\" src=\""+ imageUrl +"\" alt=\"Card image cap\">\r\n"
                + "                    <div class=\"col-sm-6\">\r\n"
